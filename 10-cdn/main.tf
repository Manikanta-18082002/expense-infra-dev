resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-dev.dawsmani.site
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.dawsmani.site
  ...
  viewer_certificate {
    ...
    ssl_support_method = "sni-only" # --> Only https 
  }
}
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.dawsmani.site --> It contains this extension
      type    = "A"
